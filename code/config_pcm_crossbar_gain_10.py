...
RUN_NAME = 'pcm_crossbar_diff_10_run_500'                       # Name of the run that will be created in data/
NUMBER_OF_RUNS = 500                                       # Number of testbenches / randomized SPICE runs
...
MODEL_FILEPATH = '../data/pcm_crossbar_diff10_spice_files/analog_MAC_32_model_1.sp'
OTHER_NECESSARY_FILES_IN_SPICE_RUN_DIRECTORY = ['../data/pcm_crossbar_diff10_spice_files/models', "../data/pcm_crossbar_diff10_spice_files/param.inc"]
LIBRARY_FILES = ['../data/pcm_crossbar_diff10_spice_files/libraries/14nfet.pm', '../data/pcm_crossbar_diff10_spice_files/libraries/14pfet.pm']
...
DF_FILENAME = "pcm_crossbar_gain_10_dataset.csv"              # Output filename for dataset
...
SAVE_MLP_MODEL = False                  # Save MLP, sklearn models
