...
if LOAD_MLP_MODELS:
    ...
    e_static_model = joblib.load(os.path.join(LASANA_MODELS_FD, 'mlp_static_energy_11_8.joblib'))
    e_model = joblib.load(os.path.join(LASANA_MODELS_FD, 'mlp_dynamic_energy_11_8.joblib'))
