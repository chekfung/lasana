...
run_metrics_filename = 'dynamic_energy_model_analysis.csv'
...
catboost_model_save_name = "spiking_neuron_catboost_dynamic_energy"
...
mlp_model_save_name = "spiking_neuron_mlp_dynamic_energy"
...
if SAVE_FIGS:
    plt.savefig('../results/mlp_dynamic_energy_model_correlation_plot.png', format='png', dpi=400)
