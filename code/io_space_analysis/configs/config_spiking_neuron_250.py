...
RUN_NAME = 'spiking_neuron_run_250'                             # Name of the run that will be created in data/
NUMBER_OF_RUNS = 250                                       # Number of testbenches / randomized SPICE runs
NUM_PROCESSES = 30                                          # Maximum number of processes that can be spun for SPICE simulations (NOTE: Each process uses a CAD license)
